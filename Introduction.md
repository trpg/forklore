...
「マスタとプレイヤたちで物語を作っていく」という点はロールプレイングゲームと同じですが、『フォルクロア』では_「ゲーム」よりも「物語を作ること」を目指したシステム設計_になっています。
...
そう、ロールプレイングゲームでは参加者はキャラクタの視点で物語の生成に関与しますが、_『フォルクロア』では作者の視点で物語の制作に関与する_のです。
## 『フォルクロア』のレイヤ構成
