...
セッション中に、パーティが何らかの選択を行うときに、この〈ストーリーポイント〉を消費します。どんな選択を採るかによって、どれだけの〈ストーリーポイント〉を消費するか、変わります。一般には、「いい結果」を選択するにはたくさんの〈ストーリーポイント〉を消費し、「悪い結果」を選択するには少量、あるいは全く〈ストーリーポイント〉を消費しません。
