...
+ マスタがシーンの状況を説明し選択肢を提示する。
+ プレイヤたちで、どのような選択肢を選択するか、なぜ選択するかを相談する。
+ シーンリーダを選出する。
++ 立候補が一人だけであれば、そのプレイヤがシーンリーダとなります。
++ 特に立候補がいないければ、シーンごとに持ち回りでプレイヤがシーンリーダを務めます。
++ 複数の立候補があった場合は、〈ストーリーポイント〉を賭けることでシーンリーダー権を取ることができます。より多くのポイントを 賭けたプレイヤがシーンリーダとなり、賭けていた〈ストーリーポイント〉は消費され、シーンリーダ自身の手番が回ってきた時に〈達成値〉に加算されます。リーダとならなかったプレイヤが賭けたポイントは消費されません。
+ シーンリーダが、このシーンの「結末」をマスタに伝える。
+ シーンリーダの指名した順に、プレイヤの手番となる。手番のプレイヤは消費する〈ストーリーポイント〉を決定する。消費した〈ストーリーポイント〉に等しいポイントが、「〈達成値〉」に加算されます。
++ 消費した〈ストーリーポイント〉が大きいほど、そのキャラクタは活躍したことを表します。どのように貢献したかについては、プレイヤが自由に描写できます。
++ 消費した〈ストーリーポイント〉の合計がシナリオで定められた〈難易度〉に到達したら、そのキャラクタはプライズを手に入れます。
++ プレイヤは、シーンの〈達成値〉に加える代わりに、「オプション」を手に入れるために一部、あるいは全部の〈ストーリーポイント〉を消費してもかまいません。
+ 全てのプレイヤが消費する〈ストーリーポイント〉を公開し終えたら、〈達成値〉が〈難易度〉以上になっているかを確認する。
++ 〈難易度〉に足りていなければ、その数分「アクシデント」（エクステンション）が発生し、結末も〈達成値〉以下の〈難易度〉の結末の中から選びなおします。
++ より〈難易度〉の高い結末を選ぶのに十分な〈達成値〉があれば、シーンリーダはそちらを選んでも構いません。
+ 結末をマスタが語り、次のシーンへと移る。
